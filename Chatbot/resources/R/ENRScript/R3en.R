...
scatter.smooth(movies$Budget / 10000, movies$Rating, main="Relation between movie budget and ratings", col = "green", lpars =list(col = "red", lwd = 3, lty = 3), xlab = "Budget in $ x10000", ylab = "Rating")
invisible(dev.off())