...
scatter.smooth(movies$Budget / 10000, movies$Rating, main="Verband tussen budget en waardering van films", col = "green", lpars =list(col = "red", lwd = 3, lty = 3), xlab = "Budget in ??? x10000", ylab = "Waardering")
invisible(dev.off())